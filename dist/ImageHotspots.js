...
class ImageHotspots extends React.Component {
    constructor(props) {
        ...
        this.render = () => {
            ...
            return (React.createElement("div", { ref: this.container, style: containerStyle, onMouseOut: event => {
                    if (dragging) {
                        this.stopDrag(event);
                    }
                }, onBlur: event => {
                ...
                src &&
                    React.createElement("img", { src: src, alt: alt, onLoad: this.onImageLoad, style: imageStyle, onMouseDown: event => {
                ...
                hotspots &&
                    React.createElement("div", { style: hotspotsStyle }, hotspots.map((hotspot, i) => React.createElement(Hotspot, { key: i, ...hotspot }))),
                !hideFullscreenControl &&
                    React.createElement("div", { style: topControlsStyle },
                        React.createElement("button", { style: buttonStyle, onClick: () => this.toggleFullscreen() }, fullscreen ? 'X' : 'FS')),
                !hideZoomControls &&
                    React.createElement(React.Fragment, null,
                        React.createElement("div", { style: bottomControlsStyle },
                            draggable &&
                                React.createElement(React.Fragment, null,
                                    React.createElement("button", { style: buttonStyle, onClick: () => this.zoom(1) }, "Fit"),
                                    React.createElement("br", null),
                                    React.createElement("br", null)),
                            React.createElement("button", { style: buttonStyle, onClick: () => this.zoom(image.scale + 1) }, "+"),
                            React.createElement("br", null),
                            React.createElement("button", { style: buttonStyle, onClick: () => this.zoom(image.scale - 1) }, "-")),
                        !hideMinimap &&
                            React.createElement("div", { style: minimapStyle },
                                src &&
                                    React.createElement("img", { src: src, width: minimapStyle.width, height: minimapStyle.height }),
                                React.createElement("div", { style: guideStyle })))));
        };
        this.state = {
            container: {
                width: undefined,
